...
const Calculator = {
  ...
  init() {
    (this.prevText = document.querySelector('.prev')),
      ...
      document
        ...
        .forEach((e) =>
          e.addEventListener('click', (e) => this.clickHandler(e))
        );
  },
  ...
  appendNumber: function (e) {
    this.currentText.innerText =
      this.currentText.innerText.toString() + e.toString();
  },
  ...
  chooseOperation: function (e) {
    '' !== this.currentText.innerText &&
      ('' !== this.prevText.innerText && this.calculate(e),
      (this.prevText.innerText = this.currentText.innerText),
      (this.currentText.innerText = ''),
      (this.lastOperator = e));
  },
  calculate: function (e = '') {
    var t = parseInt(this.prevText.innerText),
      r = parseInt(this.currentText.innerText);
    (e = '' !== e ? e : this.lastOperator),
      isNaN(t) ||
        isNaN(r) ||
        ((this.currentText.innerText = '+' === e ? t + r : t - r),
        (this.prevText.innerText = ''));
  },
};
Calculator.init();
